...
const translations = {
    tr: {
        // Hero
        heroTitle: "7/24 Çalışan Yapay Zekâ Otomasyon Sistemleri ile İşinizi Büyütün",
        heroSubtitle: "Rezervasyonları, müşteri iletişimini, randevuları ve satış süreçlerini tek bir akıllı altyapı üzerinden tamamen otomatik hale getirin.",
        ...
        trustItem2: "7/24 Otomatik Müşteri İletişim Sistemleri",
        trustItem3: "CRM & Rezervasyon Entegrasyon Uzmanlığı",
        trustItem4: "Veri Odaklı Dönüşüm ve Performans Analitiği",

        // Navigation & General Links
        fLinkCompany: "Hakkımızda",
        fLinkVision: "Vizyon & Misyon",
        fLinkTech: "Hizmetlerimiz",
        ...
        service1Desc: "İş modelinizi analiz ediyor, süreçlerinizi dijitalleştiriyor ve yapay zeka destekli büyüme stratejileri oluşturuyoruz.",
        service2Title: "YAPAY ZEKA & AKILLI OTOMASYON SİSTEMLERİ",
        service2Desc: "GPT tabanlı chatbotlar, CRM akışları, satış otomasyonları ve iş süreçlerini hızlandıran akıllı sistemler geliştiriyoruz.",
        ...
        aboutFeature1: "Kurumsal Dijital Çözüm Ortağınız",
        ...
        footerCol2Title: "Hizmetlerimiz",
        footerCol3Title: "Sektörler",
        footerCol4Title: "İletişim",

        // Footer Links
        fLinkAISol: "Yapay Zeka Çözümleri",
        fLinkAutoSys: "Otomasyon Sistemleri",
        fLinkChatbot: "Chatbot & AI Asistanlar",
        fLinkDigital: "Dijital Dönüşüm Danışmanlığı",
        fLinkManagement: "Yönetim",
        fLinkValues: "Değerlerimiz",
        fLinkWhyUs: "Neden Biz?",
        fLinkHealth: "Sağlık Teknolojileri",
        fLinkTourism: "Turizm & Hizmet Sektörü",
        fLinkEcommerce: "E-Ticaret",
        fLinkCorporate: "Kurumsal & KOBİ Çözümleri",

        // Target Industries Section
        industriesTitle: "Hedef Sektörler",
        ...
        faqQ7: "BY Sirius Group hangi hizmetleri sunuyor?",
        faqA7: "BY Sirius Group; yapay zeka otomasyon sistemleri, WhatsApp chatbot entegrasyonu, CRM otomasyonu, randevu yönetim sistemleri, dijital dönüşüm danışmanlığı ve özel yazılım geliştirme hizmetlerinin yanı sıra görsel iyileştirme uygulaması, QR menü sistemi ile salon ve işletme yönetimi gibi mobil ve web uygulamaları da sunmaktadır.",
        faqQ8: "Hangi sektörlere hizmet veriyorsunuz?",
        faqA8: "Oteller, diş klinikleri, güzellik ve kuaför merkezleri, gayrimenkul ofisleri, spor salonları, hukuk büroları, e-ticaret işletmeleri ve KOBİ'ler dahil pek çok sektöre özel AI otomasyon çözümleri ve sektöre özgü uygulamalar geliştiriyoruz.",
        faqQ9: "Ücretsiz analiz nasıl talep edilir?",
        faqA9: "Sitemizdeki \"Ücretsiz Analiz Talep Edin\" formunu doldurarak veya info@bysirius.com adresine e-posta göndererek ücretsiz ön analiz randevusu alabilirsiniz.",
        ...
        // AI Chat Panel
        chatTitle: "AI Strateji Asistanı",
        chatSubtitle: "BY Sirius Group Gücüyle",
        chatWelcome: "Merhaba! Ben Sirius AI Asistanı. Projeleriniz veya teknoloji stratejileriniz hakkında size nasıl yardımcı olabilirim?",
        chatPlaceholder: "Mesajınızı buraya yazın...",
        chatBotResponse: "İletiniz için teşekkürler. Strateji asistanımız şu anda geliştirme aşamasındadır. Detaylı yardım için 'İletişim' bölümünden bize ulaşabilirsiniz."
    },
    en: {
        // Hero
        heroTitle: "Grow Your Business with 24/7 AI Automation Systems",
        ...
        trustItem2: "24/7 Automated Customer Communication Systems",
        trustItem3: "CRM & Booking Integration Expertise",
        trustItem4: "Data-Driven Transformation & Performance Analytics",

        // Navigation & General Links
        fLinkCompany: "About Us",
        fLinkVision: "Vision & Mission",
        fLinkTech: "Services",
        ...
        service1Desc: "We analyze your business model, digitize your processes, and create AI-powered growth strategies.",
        service2Title: "AI & SMART AUTOMATION SYSTEMS",
        service2Desc: "We develop GPT-based chatbots, CRM workflows, sales automations, and smart systems that accelerate business processes.",
        ...
        aboutFeature1: "Your Corporate Digital Solution Partner",
        ...
        footerCol3Title: "Industries",
        footerCol4Title: "Contact",

        // Footer Links
        fLinkAISol: "AI Solutions",
        fLinkAutoSys: "Automation Systems",
        fLinkChatbot: "Chatbot & AI Assistants",
        fLinkDigital: "Digital Transformation Consulting",
        fLinkManagement: "Management",
        fLinkValues: "Our Values",
        fLinkWhyUs: "Why Us?",
        fLinkHealth: "Health Technologies",
        fLinkTourism: "Tourism & Hospitality",
        fLinkEcommerce: "E-Commerce",
        fLinkCorporate: "Enterprise & SME Solutions",
        ...
        faqQ7: "What services does BY Sirius Group offer?",
        faqA7: "BY Sirius Group offers AI automation systems, WhatsApp chatbot integration, CRM automation, appointment management systems, digital transformation consulting and custom software development, as well as mobile and web applications such as an image enhancement app, QR menu system, and salon & business management solution.",
        faqQ8: "Which industries do you serve?",
        faqA8: "We develop custom AI automation solutions and industry-specific applications for hotels, dental clinics, beauty and hair salons, real estate offices, gyms, law firms, e-commerce businesses and SMEs.",
        faqQ9: "How can I request a free analysis?",
        faqA9: "You can get a free preliminary analysis appointment by filling out the \"Request Free Analysis\" form on our website or by sending an email to info@bysirius.com.",
        ...
        // AI Chat Panel
        chatTitle: "AI Strategy Assistant",
        chatSubtitle: "Powered by BY Sirius Group",
        chatWelcome: "Hello! I am your Sirius AI Assistant. How can I help you with your projects or technology strategy today?",
        chatPlaceholder: "Type your message here...",
        chatBotResponse: "Thank you for your message. Our strategy assistant is currently in development. For detailed assistance, please contact us via the 'Contact' section."
    },
    de: {}, // German (Inactive)
    ru: {}, // Russian (Inactive)
    es: {}, // Spanish (Inactive)
    ar: {}  // Arabic (Inactive, RTL Ready)
};
...
class LanguageSystem {
    ...
    updateUI(lang) {
        ...
        document.querySelectorAll('[aria-label][data-i18n-label]').forEach(element => {
            const key = element.getAttribute('data-i18n-label');
            if (langData[key]) element.setAttribute('aria-label', langData[key]);
        });

        document.querySelectorAll('[title][data-i18n-title]').forEach(element => {
    ...
    accordionItems.forEach(item => {
        ...
        if (header) {
            header.addEventListener("click", function (e) {
                // If the click was on the modal button inside the body, don't toggle
                if (e.target.closest('.btn-modal-trigger')) return;
...
})(window,document,'clarity','script','x5i5f7wtfi');
